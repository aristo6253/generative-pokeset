...
class Discriminator_128_G(nn.Module):
    def __init__(self) -> None:
        super(Discriminator_128_G, self).__init__()
        self.main = nn.Sequential(
...
class Generator_128_G(nn.Module):
    def __init__(self) -> None:
...
class Discriminator_128_RGB(nn.Module):
    def __init__(self) -> None:
        super(Discriminator_128_RGB, self).__init__()
        self.main = nn.Sequential(
...
class Generator_128_RGB(nn.Module):
    def __init__(self) -> None:
        super(Generator_128_RGB, self).__init__()
        self.main = nn.Sequential(
            # Input is 100, going into a convolution.
            nn.ConvTranspose2d(in_channels=100, out_channels=512, kernel_size=(4, 4), stride=(1, 1), padding=(0, 0), bias=False),
            nn.BatchNorm2d(512),
